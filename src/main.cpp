...
int main() {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesCubeNormals), verticesCubeNormals, GL_STATIC_DRAW);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //---------------------simple shader---------------------------
        /*simpleShader.setFloat("mixValue", sin(glfwGetTime()) / 2 + .5f);
